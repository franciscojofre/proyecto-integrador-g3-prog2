...
INSERT INTO `products` (`id`,`title`,`descrip`,`image`,`user_id`,`createdAt`,`updatedAt`,`deletedAt`) VALUES (5,'Teclado ASUS TUF GAMING K3 Aura Sync RGB','Teclado ASUS TUF Gaming K5 RGB con teclas de sensación mecánica, revestimiento especializado para mayor durabilidad, resistencia a derrames e iluminación Aura Sync. Teclas de sensación mecánica, 24 key-rollover para un mayor rendimiento. Validado para uso rudo, con un recubrimiento especializado para mayor durabilidad y resistencia a los derrames. Cinco zonas de iluminación ASUS Aura Sync RGB personalizables individualmente con sincronización entre dispositivos. Teclas multimedia dedicadas en la parte superior izquierda para ajustes instantáneos de volumen sin interrumpir tu juego. Reposamuñecas ergonómico integrado y ajuste de ángulo de dos niveles para una comodidad óptima. Teclas totalmente programables con grabación de macros sobre la marcha y memoria integrada para un juego personalizado. Armory II, utilidad con controles extensos y una interfaz de usuario intuitiva para fáciles configuraciones.','imgProduct-1655927205700.jpg',2,'2022-06-22 16:46:45','2022-06-22 16:46:45',NULL);
